    ...
    card: {
      card: {
        ...
        info: {
          ...
          promoted: true,
          adTrackingId:
            "cid=18839655~p=0~adgrpid=18839655#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=18987~eid=289b379a-9122-4a7c-8b98-db0bd2c3087a~srvts=1727081663667~collid=83639",
          sla: {
            deliveryTime: 35,
            lastMileTravel: 4.4,
                ...
                badgeObject: [
                  {
                    attributes: {
                      description: "Delivery!",
                      imageId:
                        "Green%20Dot%20Awards/Best%20In%20Veg%20Biryani.png",
                    },
                  },
                  {
                    attributes: {
        ...
        analytics: {},
        cta: {
          link: "swiggy://menu?restaurant_id=18987&source=collection&query=Biryani",
    ...
    card: {
      card: {
        ...
        info: {
          ...
          promoted: true,
          adTrackingId:
            "cid=18839941~p=2~adgrpid=18839941#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=537139~eid=817d1039-2db3-428b-9590-e59391c7c4f0~srvts=1727081663667~collid=83639",
          sla: {
            deliveryTime: 18,
            lastMileTravel: 1.3,
            serviceability: "SERVICEABLE",
    ...
    card: {
      card: {
        ...
        info: {
          ...
          promoted: true,
          adTrackingId:
            "cid=18840349~p=3~adgrpid=18840349#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=425~eid=2336c48e-9bb2-4191-ab06-5b24e52a485b~srvts=1727081663667~collid=83639",
          sla: {
            deliveryTime: 32,
            lastMileTravel: 1.3,
            serviceability: "SERVICEABLE",
        ...
        analytics: {},
        cta: {
          link: "swiggy://menu?restaurant_id=425&source=collection&query=Biryani",
          text: "RESTAURANT_MENU",
          type: "DEEPLINK",
        },
        widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food",
    ...
    card: {
      card: {
        ...
        info: {
          ...
          promoted: true,
          adTrackingId:
            "cid=17785661~p=6~adgrpid=17785661#ag1~mp=SWIGGY_IN~bl=FOOD~aet=RESTAURANT~aeid=375041~eid=e33ad4c9-2255-4038-a299-11212ff93026~srvts=1727081663668~collid=83639",
          sla: {
            deliveryTime: 22,
            lastMileTravel: 0.7,
            serviceability: "SERVICEABLE",
  ...
  return (
    <div className="res-card">
      <img
        className="res-logo"
        src={
          "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + resData.card.card.info.cloudinaryImageId
        }
      />
      <h3>{name}</h3>
      <h4>{cuisines.join(",")}</h4>
